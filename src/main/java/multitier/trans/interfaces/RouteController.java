package multitier.trans.interfaces;
import multitier.trans.application.dto.CreateRouteRequest; // Import the DTO
import multitier.trans.domain.model.Route;
import multitier.trans.application.service.RouteService; // Import the Service Interface
