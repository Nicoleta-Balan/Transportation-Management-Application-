...
**Note**: The database schema is automatically initialized:
- **Core tables**: Auto-generated by JPA/Hibernate from entity classes
- **Functions & Triggers**: Managed by Flyway migrations (V1-V3 in `src/main/resources/db/migration/`)
- **Sample data**: Automatically loaded via `@PostConstruct` in `DataInitializer.java` (if `app.data.initialize=true`)
